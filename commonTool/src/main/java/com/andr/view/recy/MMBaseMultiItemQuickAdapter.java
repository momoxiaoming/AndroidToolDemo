 ...
 * @param <K>
 */
public abstract class MMBaseMultiItemQuickAdapter<T extends MultiItemEntity, K extends BaseViewHolder> extends BaseMultiItemQuickAdapter<T, K>
{
     ...
     */
    public MMBaseMultiItemQuickAdapter(Context context, List<T> data)
    {
        super(data);
    ...
    {
        setMMData(page, hasNext, mList,"网络好像开小差了!","网络好像开小差了!");
    }
